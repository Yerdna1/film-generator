...
export const SUBSCRIPTION_PLANS = {
  free: {
    ...
    features: ['500 credits on signup', 'Basic features', 'Community support'],
  },
  starter: {
    name: 'Starter',
    price: 9,
    ...
    features: ['2,000 credits/month', 'All AI models', 'Email support'],
  },
  pro: {
    name: 'Pro',
    price: 29,
    ...
    features: ['8,000 credits/month', 'Priority generation', 'Priority support'],
  },
  studio: {
    name: 'Studio',
    price: 79,
    ...
    features: ['25,000 credits/month', 'Highest priority', 'Dedicated support'],
  },
} as const;
